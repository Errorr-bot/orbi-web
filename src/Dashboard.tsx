    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle at 40% 35%, #FFFFFF, #EBD6FF 60%, rgba(255,255,255,0.0) 70%)',
          position: 'relative'
        }}>
          {/* floating shards (simple) */}
          <div style={{
            position: 'absolute', top: -8, right: -8, width: 22, height: 22,
            transform: 'rotate(45deg)', background: '#F3C6FF', borderRadius: 4, opacity: 0.9
          }} />
          <div style={{
            position: 'absolute', bottom: -10, left: -6, width: 18, height: 18,
            transform: 'rotate(25deg)', background: '#FFD0F0', borderRadius: 4, opacity: 0.9
          }} />
        </div>
